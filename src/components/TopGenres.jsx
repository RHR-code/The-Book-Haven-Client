    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10  p-10">
        <div className="relative  flex items-center justify-center ">
          ...
          <h2 className="font-bold text-5xl shadow-2xl  absolute text-white top-[50%] left-[50%] -translate-[50%]">
            Thriller
          </h2>
        </div>
        <div className="relative  flex items-center justify-center ">
          ...
          />
          <div className="bg-black/30  absolute inset-0 rounded-2xl"></div>
          <h2 className="font-bold text-5xl text-center shadow-2xl  absolute text-white top-[50%] left-[50%] -translate-[50%]">
            Science
          </h2>
        </div>
        <div className="relative  flex items-center justify-center ">
